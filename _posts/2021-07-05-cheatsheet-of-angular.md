...
## Proxying
When you wish to make request from your angular project to server which is not in the same port, domain or hosts. You cannot fetch the desired resources and display it on your app
